        ...
        <div class="container">
            <div class="row full-screen align-items-center">
                <div class="home-text">
                    ...
                    <h1>Diseñador Web</h1>
                    <a href="#about" class="link-item btn-1 outer-shadow hover-in-shadow">Leer más</a>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="about-info">
                    ...
                    <p>
                        Mi misión es ayudarte emprender e impulsar tu marca!
                    </p>
            ...
            <div class="row">
                ...
                <div class="service-item">
                    <div class="service-item-inner outer-shadow">
                        ...
                        <p>
                            Filosofía del diseño web cuyo objetivo es el de adaptar la apariencia de los sitios web al
                            dispositivo que se esté usando para visitarlos.
                        </p>
                    </div>
                </div>
                <!-- SERVICIOS ITEMS FIN -->
                ...
                <div class="service-item">
                    <div class="service-item-inner outer-shadow">
                        ...
                        <h3>Diseño Web</h3>
                        <p>
                            Área enfocada en el diseño de sitios y aplicaciones para web.
                        </p>
                    </div>
                </div>
                <!-- SERVICIOS ITEMS FIN -->
                ...
                <div class="service-item">
                    <div class="service-item-inner outer-shadow">
                        ...
                        <h3>Diseño UI</h3>
                        <p>
                            Diseño de interfaz de usuario, es el resultado de definir la forma, función, utilidad,
                            ergonomía, imagen de marca y otros aspectos que afectan a la apariencia externa de las
                ...
                <div class="service-item">
                    <div class="service-item-inner outer-shadow">
                        ...
                        <h3>Código Limpio</h3>
                        <p>
                            Es el arte del desarrollo que consiste en aplicar técnicas simples que faciliten la
                            escritura, lectura e interpretación de un código, volviéndolo mas fácil de entender.
                        </p>
                    </div>
                </div>
                <!-- SERVICIOS ITEMS FIN -->
                ...
                <div class="service-item">
                    <div class="service-item-inner outer-shadow">
                        ...
                        <h3>E - commerce</h3>
                        <p>
                            Es definido como la venta, compra y distribución de algún suministro, producto, servicio o
                            información a traves de internet.
                        </p>
                    </div>
                </div>
                <!-- SERVICIOS ITEMS FIN -->
                ...
                <div class="service-item">
                    <div class="service-item-inner outer-shadow">
                        ...
                        <h3>Gran Apoyo</h3>
                        <p>
                            A lo largo del proceso sea cual sea el servicio elegido por ti como cliente, tendrás mi
                            apoyo y completa disposición en ayudarte a cumplir tus objetivos!
                        </p>
                    </div>
                </div>
                <!-- SERVICIOS ITEMS FIN -->
